...
//                getString(R.string.ci_31_desc)));
    ...
    protected void initViews() {
        mToolbar.setTitle("Emotion Recognition");
...
//                        startActivity(i);
                        Intent serverIntent = new Intent(MainActivity.this, MainActivity2.class);
                        startActivity(serverIntent);
                        break;
                    case R.id.report:
                        Intent notificationIntent = new Intent(MainActivity.this, MainActivity3.class);
...
//                        break;
                    case R.id.blog:
                        Intent timeIntent = new Intent(MainActivity.this, MainActivity4.class);
